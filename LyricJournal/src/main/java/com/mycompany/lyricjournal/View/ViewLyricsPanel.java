...
public class ViewLyricsPanel extends JPanel {
    ...
    private JPanel createEntryPanel(LyricEntry entry) {
        ...
        artistLabel.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 10)); // Add padding around artist text
...
//        deleteButton.setPreferredSize(new Dimension(70, 25));
        ...
        // Button actions - removed unused index parameters
        editButton.addActionListener(e -> editEntry(entry));
        deleteButton.addActionListener(e -> deleteEntry(entry));
