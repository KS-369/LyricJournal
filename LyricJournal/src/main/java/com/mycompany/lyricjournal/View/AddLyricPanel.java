...
public class AddLyricPanel extends JPanel {
     ...
     * 
     * @param user - The current User object to add entries to
     * @param parent - The main GUI window for navigation callbacks
     */
    public AddLyricPanel(User user, LyricJournalMainGUI parent) {
        ...
        clearButton.addActionListener(e -> clearFields()); // Clear form when Clear clicked

        // Enable Enter key navigation between fields for better UX
     ...
     * 
     * Clears all text from input fields and returns focus to first field
     * for efficient data entry workflow.
     * 
